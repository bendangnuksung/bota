def heroes_dict():
    return {
      "heroes": [
        ...
        {
          "name": "vengefulspirit",
          "displayname": "vengefulspirit",
          "showname": "Vengeful Spirit",
          "class": "agi",
          "id": 20
        },
        {
